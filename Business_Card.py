...
icon = Image.open(r"C:\Users\pbsun\Downloads\5.png")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By ` POOJA SUNAGAR `",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by `POOJA...!`"""})
